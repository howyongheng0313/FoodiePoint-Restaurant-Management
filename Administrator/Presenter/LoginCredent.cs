...
namespace Admin.Presenter
{
    public class LoginCredent
    {
        ...
        public static LoginCredent Login(string usrnm, string paswd)
        {
        ...
        public LoginCredent(string userID, string username, string password, string fullName, string email, string role)
        {
            UserID = userID;
            Username = username;
            Password = password;
